"""
This file runs the second strategy (agent 2). for each of the flammabilites we
test the program will find the shortest path and execute it while advancing the 
fire after each time step. After each time step we recaculate a route based on 
...
print("Agent 2 Simulation Complete")
...
plt.title("Agent 2 Graph Simulation")
plt.show()
